...
TOKEN = 'AgGagMEWGlvPNYDeMzPgl6zkxY7GNDDo7kJ5PPY5dODjMJ28ybt7CEPPd2qMQapO4ll45lDOvqr9pdSQkq3DGFw6E4'
...
with open('stan_kaggle_hubmap_ids.csv') as csv_file:
...
open('rui_locations.stan.jsonld', 'w').write(json.dumps(data, indent=2))
